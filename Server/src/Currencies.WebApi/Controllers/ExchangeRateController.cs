...
using Currencies.Api.Modules.ExchangeRate.Commands.Delete;
using Currencies.Api.Modules.ExchangeRate.Commands.Update;
using Currencies.Api.Modules.ExchangeRate.Queries.GetAll;
using Currencies.Api.Modules.ExchangeRate.Queries.GetEditForm;
using Currencies.Api.Modules.ExchangeRate.Queries.GetSingle;
using Currencies.Api.Modules.ExchangeRate.Queries.GetSingleFromCurrency;
