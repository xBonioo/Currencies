...
public interface ICurrencyService
{
    ...
    Task<CurrencyDto?> CreateCurrencyAsync(BaseCurrencyDto createCurrencyDto, CancellationToken cancellationToken);
    Task<CurrencyDto?> UpdateCurrencyAsync(int currencyId, BaseCurrencyDto updateCurrencyDto, CancellationToken cancellationToken);
