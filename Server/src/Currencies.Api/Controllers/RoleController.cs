using Currencies.Api.Modules.Role.Commands.Create;
using Currencies.Api.Modules.Role.Commands.Delete;
using Currencies.Api.Modules.Role.Commands.Update;
using Currencies.Api.Modules.Role.Queries.GetAll;
using Currencies.Api.Modules.Role.Queries.GetEditForm;
using Currencies.Api.Modules.Role.Queries.GetSingle;
